...
import 'registered_groups_screen.dart';
...
class _SubjectsScreenState extends State<SubjectsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => DefaultAppBarLayout(
        ...
        additionalOptions: const ['Go to groups'],
        optionFunctions: {
          'Go to groups': () {
            Get.to(() => const RegisteredGroupScreen(),
                arguments: {'showDrawer': false});
          },
        },
        drawer: false,
        title: 'Subjects',
                    ...
                    children: [
                      Obx(() => TextFormField(
                            ...
                            decoration: InputDecorations.generalInputDecoration(
                                ...
                                labelColor: subjectController.editionMode.value
                                    ? CustomColors.red
                                    : null),
                            validator: (value) {
                                ...
                                Expanded(
                                  child: SwitchListTile(
                                    contentPadding: const EdgeInsets.only(
                                        right: 0, top: 4, left: 15, bottom: 4),
